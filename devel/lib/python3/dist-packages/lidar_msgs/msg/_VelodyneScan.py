...
"""autogenerated by genpy from lidar_msgs/VelodyneScan.msg. Do not edit."""
import codecs
import sys
...
class VelodyneScan(genpy.Message):
  _md5sum = "959ef76e31922a901758298cc4ccbba3"
  _type = "lidar_msgs/VelodyneScan"
...
"""
  ...
  _slot_types = ['std_msgs/Header','lidar_msgs/VelodynePacket[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lidar_msgs.msg.VelodynePacket()
        _v3 = val1.stamp
        _v4 = _v3.data
        _x = _v4
        start = end
