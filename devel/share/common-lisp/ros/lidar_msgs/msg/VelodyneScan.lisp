...
(cl:defclass <VelodyneScan> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (packets
    :reader packets
    :initarg :packets
    :type (cl:vector lidar_msgs-msg:VelodynePacket)
   :initform (cl:make-array 0 :element-type 'lidar_msgs-msg:VelodynePacket :initial-element (cl:make-instance 'lidar_msgs-msg:VelodynePacket))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VelodyneScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelodyneScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_msgs-msg:<VelodyneScan> is deprecated: use lidar_msgs-msg:VelodyneScan instead.")))
...
(cl:defmethod packets-val ((m <VelodyneScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_msgs-msg:packets-val is deprecated.  Use lidar_msgs-msg:packets instead.")
  (packets m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VelodyneScan>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'packets)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar_msgs-msg:VelodynePacket))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VelodyneScan>)))
  ...
  "959ef76e31922a901758298cc4ccbba3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VelodyneScan)))
  "Returns md5sum for a message object of type 'VelodyneScan"
  "959ef76e31922a901758298cc4ccbba3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VelodyneScan>)))
  ...
  (cl:format cl:nil "# Velodyne LIDAR scan packets.~%~%std_msgs/Header    header~%VelodynePacket[]   packets~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lidar_msgs/VelodynePacket~%# Raw Velodyne LIDAR packet.~%~%std_msgs/Time   stamp~%uint8[1206]     data~%~%================================================================================~%MSG: std_msgs/Time~%time data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VelodyneScan)))
  "Returns full string definition for message of type 'VelodyneScan"
  (cl:format cl:nil "# Velodyne LIDAR scan packets.~%~%std_msgs/Header    header~%VelodynePacket[]   packets~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lidar_msgs/VelodynePacket~%# Raw Velodyne LIDAR packet.~%~%std_msgs/Time   stamp~%uint8[1206]     data~%~%================================================================================~%MSG: std_msgs/Time~%time data~%~%~%"))
